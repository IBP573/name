...
const app = express();
const Title = "Stumble Race Backend " + (process.env.version || "1.0.0");
...
app.get("/", (req, res) => {
  res.status(200).json({
    status: "ONLINE",
    message: "StumbleName Backend funcionando perfeitamente!",
...
app.get('/economy/luckyspin', (req, res) => EconomyController.getLuckySpin(req, res));
